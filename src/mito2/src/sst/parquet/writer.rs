...
/// Parquet SST writer.
pub struct ParquetWriter<F: WriterFactory, P: FilePathProvider> {
...
impl<P> ParquetWriter<ObjectStoreWriterFactory, P>
where
    P: FilePathProvider,
{
    pub async fn new_with_object_store(
        ...
        metadata: RegionMetadataRef,
        path_provider: P,
    ) -> ParquetWriter<ObjectStoreWriterFactory, P> {
        ParquetWriter::new(
